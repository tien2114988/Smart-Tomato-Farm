...
const AccountSchema = new mongoose.Schema({
  ...
  const TemperatureThreshold = mongoose.model('TemperatureThreshold', TemperatureThresholdSchema);
  const AirHumidityThreshold = mongoose.model('AirHumidityThreshold', AirHumidityThresholdSchema);
  const SoilMoistureThreshold = mongoose.model('SoilMoistureThreshold', SoilMoistureThresholdSchema);
